  ...
  return (
    <div className="phone bg-ink-950 text-white">
      <div className="flex-1 flex flex-col justify-between p-7">
        <div className="pt-10">
          <div className="w-16 h-16 rounded-3xl bg-brand-500 grid place-items-center text-3xl mb-6">🚕</div>
          <h1 className="text-3xl font-bold leading-tight">ADM Taksi</h1>
          <p className="text-ink-400 mt-2">Bir tugma bilan mashina chaqiring — tez, qulay, arzon.</p>
        </div>
          ...
          {step === 'phone' ? (
            ...
            <>
              ...
              <input value={name} onChange={(e) => setName(e.target.value)}
                className="w-full rounded-2xl bg-white/10 border border-white/10 px-4 py-4 outline-none focus:border-brand-400" placeholder="Ismingiz (ixtiyoriy)" />
