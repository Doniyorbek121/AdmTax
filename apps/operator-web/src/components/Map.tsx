...
export function Map({
  ...
  return (
    ...
    >
      ...
      {pickup && dropoff && (
        <Polyline positions={[[pickup.lat, pickup.lng], [dropoff.lat, dropoff.lng]]} pathOptions={{ color: '#171b26', weight: 4, dashArray: '1 10', lineCap: 'round' }} />
      )}
      <Fit points={pts.length ? pts : [TASHKENT_CENTER]} />
    </MapContainer>
  );
}
