      ...
      <div className="flex-1 flex flex-col justify-between p-7">
        <div className="pt-10">
          <div className="flex items-center justify-between mb-6">
            <div className="w-16 h-16 rounded-3xl bg-brand-500 grid place-items-center text-3xl">🧑‍✈️</div>
          ...
          <h1 className="text-3xl font-bold leading-tight">{t('ADM Haydovchi')}</h1>
          <p className="text-ink-400 mt-2">{t("Onlayn bo'ling, buyurtma oling, daromad qiling.")}</p>
        </div>
